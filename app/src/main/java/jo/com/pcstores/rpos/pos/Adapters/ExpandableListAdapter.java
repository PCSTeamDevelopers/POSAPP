...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        try {
            ...
            if (flag.equals(_context.getResources().getString(R.string.Total))) {
            ...
            btnEdit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    try {
                        ...
                        String[] tax = _context.getResources().getStringArray(R.array.taxArray);
                        ...
                        alertDialogBuilder.setTitle(R.string.editItem);
                ...
                lblListHeader.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        try {
                            ...
                            alertDialogBuilder.setTitle(R.string.editCategory);
                            alertDialogBuilder.setIcon(_context.getResources().getDrawable(R.drawable.edit));
                            alertDialogBuilder
                                    .setPositiveButton(android.R.string.ok,
                                            new DialogInterface.OnClickListener() {
